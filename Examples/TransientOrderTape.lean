...
deliberately composed differently from `Examples.TransientLedger`: three-limb
...
namespace Examples.TransientOrderTape

open ProofForge.Svm.Sdk

/-- Minimal managed state, mirroring `Examples.TransientPair` so this module stays inside the
...
end Examples.TransientOrderTape
