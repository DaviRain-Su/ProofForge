...
/-- Caller burns 5 of own points and cuts contract `supp`. Frozen → 5.
`subSelfSupp` rewrites persist Owner; flush caller `bal` first. -/
@[pf_entry]
