...
def main (args : List String) : IO UInt32 := do
  ...
  let phase ← SolanaLean.Assemble.assembleProgram out SolanaLean.IR.extractedPhase
  IO.println s!"wrote {phase.asmPath} and {phase.soPath} ({phase.soBytes.size} bytes)"
  return 0
