...
| [svm-app-007](tasks/svm-app-007.md) | Phoenix CancelMultipleById tag-11 capacity 4→8 | **done** — tag11 maxDataLen 141; tag10 stays 73; Mollusk eight-id free-funds + reject len=9 |
...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[010](tasks/svm-sem-010.md) | walked `r7` + account-0 host knives | **done** — `r7` + account-0 header/key/flags/lamports/data_len |
