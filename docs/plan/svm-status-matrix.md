...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[037](tasks/svm-sem-037.md) | walked `r7` + account-0/1/2/3 host knives + account-4 skip/meta/flags | **done** — account-4 marker+key+flags |
