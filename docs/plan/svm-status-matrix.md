...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[038](tasks/svm-sem-038.md) | walked `r7` + account-0/1/2/3 host knives + account-4 skip/meta/flags/budget | **done** — account-4 marker+key+flags+budget |
