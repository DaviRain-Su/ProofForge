...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[028](tasks/svm-sem-028.md) | walked `r7` + account-0/1/2 host knives + account-3 skip | **done** — account-0/1/2 full field walks; account-3 marker skip |
