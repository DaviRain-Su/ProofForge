...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[111](tasks/svm-sem-111.md) | walked `r7` + account-0..14 skip host knives | **doing** — account-14 field arc landed; acc14→acc15 skip open |
