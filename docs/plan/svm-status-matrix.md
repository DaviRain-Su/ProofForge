...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[029](tasks/svm-sem-029.md) | walked `r7` + account-0/1/2 host knives + account-3 skip/meta | **done** — account-0/1/2 full walks; account-3 marker+key |
