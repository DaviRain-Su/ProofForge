...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[015](tasks/svm-sem-015.md) | walked `r7` + account-0/1 host knives | **done** — `r7` + account-0 fields/skip-to-next + account-1 header/key |
