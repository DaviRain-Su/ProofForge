...
| ID | Slice | Status |
|---|---|---|
| [svm-app-001](tasks/svm-app-001.md) | Phoenix-v1 next instruction group | todo |
...
| E1 | [svm-sem-001](tasks/svm-sem-001.md) | Operand materialization + straightline | todo |
| E2 | [svm-sem-002](tasks/svm-sem-002.md) | `.s` golden ↔ sbpfSemantics | todo |
