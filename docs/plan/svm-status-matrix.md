...
| E∞ | [svm-sem-006](tasks/svm-sem-006.md)–[021](tasks/svm-sem-021.md) | walked `r7` + account-0/1/2 host knives | **done** — account-0 full + account-1 full + account-1→2 skip chain |
