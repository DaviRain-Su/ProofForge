...
| 类别 | 当前 source surface | 主要缺口 | 优先级 |
|---|---|---|---|
| values/ABI | typed scalars、Address/u128/u256/bytesN、shared checked u128/u256→u64 narrowing、effect-prefixed static wide result frames、static aggregates、tagged input、bounded dynamic-array/bytes/string input、top-level one-limb bounded/tagged output、strict UTF-8 | signed ints、其余 safe cast targets、nested/constructed wide dynamic return、dynamic constructor/fallback returndata | F0/F1 |
