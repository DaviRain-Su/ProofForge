...
|---|---|---|---|
| integers/fixed bytes | Bool、u8/16/32/64、allocation-free u128/u256/`FixedBytes n`；shared checked u128/u256→u8/u16/u32/u64 narrowing；shared allocation-free UInt64 min/max/floor-average/checked-ceilDiv、explicit saturating add/sub/mul、floor/ceiling log2/log10/log256 与 integer sqrt；u256 EVM arithmetic 已覆盖主要 unsigned op | signed widths、wide saturation/full-precision helpers、统一 overflow vocabulary | F0/F1 |
