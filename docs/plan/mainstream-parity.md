...
|---|---|---|---|
| integers/fixed bytes | Bool、u8/16/32/64、allocation-free u128/u256/`FixedBytes n`；shared checked u128/u256→u32/u64 narrowing；u256 EVM arithmetic 已覆盖主要 unsigned op | signed widths、consumer-driven u16/u8 safe casts、saturating/full-precision helpers、统一 overflow vocabulary | F0/F1 |
...
| 类别 | 当前 source surface | 主要缺口 | 优先级 |
|---|---|---|---|
| values/ABI | typed scalars、Address/u128/u256/bytesN、shared checked u128/u256→u32/u64 narrowing、effect-prefixed static wide result frames、static aggregates、tagged input、bounded dynamic-array/bytes/string input、top-level one-limb bounded/tagged output、strict UTF-8 | signed ints、consumer-driven u16/u8 safe casts、nested/constructed wide dynamic return、dynamic constructor/fallback returndata | F0/F1 |
