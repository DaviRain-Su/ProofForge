...
|---|---|---|---|
| integers/fixed bytes | Bool、u8/16/32/64、allocation-free u128/u256/`FixedBytes n`；shared checked u128/u256→u8/u16/u32/u64 narrowing；u256 EVM arithmetic 已覆盖主要 unsigned op | signed widths、saturating/full-precision helpers、统一 overflow vocabulary | F0/F1 |
...
| 组件 | 当前 | 主要缺口 | 优先级 |
|---|---|---|---|
| collections/math | shared checked u128/u256→u8/u16/u32/u64 SafeCast、typed maps、static declarations、capacity-2 role set、checked u256 operations、persistent bounded UInt64 vector/bitmap/ring/enumerable set/map/checkpoints | signed casts、richer Math/String/Bytes utilities、richer keys/values/elements、wider checkpoints and iteration shapes | F0/F2 |
