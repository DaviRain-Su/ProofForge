...
| else-if A cancel / B cashB | `XrplEscape` | `escape.sh` |
| freeze-gated latch | `XrplFrost` | `frost.sh` |
...
| operator pause A cancel / B cashB | `XrplClasp` | `clasp.sh` |
| mint cap A cancel / B cashB | `XrplCleft` | `cleft.sh` |
| sendToB / clawB freeze A cancel / B cashB | `XrplClip` | `clip.sh` |
...
| sendToB / clawB / freeze cashSelf | `XrplReed` | `reed.sh` |
| grant / takeB / freeze cashSelf | `XrplRake` | `rake.sh` |
| grant / takeB / clawB / freeze cashSelf | `XrplRaid` | `raid.sh` |
| grant / takeB / pause cashSelf | `XrplRamp` | `ramp.sh` |
| grant / takeB / pause+freeze cashSelf | `XrplRank` | `rank.sh` |
| grant / takeB / clawB / pause+freeze cashSelf | `XrplRant` | `rant.sh` |
