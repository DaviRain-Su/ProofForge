...
| cross-contract call | promise receipt/action host ABI | **detached/returned static calls plus one returned authenticated self-callback edge complete** in wsm-near-promise-001/002, wsm-near-promise-then-001, and wsm-near-promise-private-001; joins absent | Runtime promise effects, then typed SDK builder |
...
observation with strict UInt64 decode. It is not yet a general near-sdk-rs contract model.
