...
- **当前可验证基线（2026-08-28）**：Lean 汇总 281 jobs；SVM manifest 全 54 programs；
...
- R3-002 SVM Account/Signer facade 已完成：`Svm.Sdk.Account.Handle`、`Signer.Handle` 与直接
  ...
  `docs/plan/tasks/r3-002.md`。R3 的 PDA/System/Token facade 和 bounded transient Scratch
  仍未完成。
...
- `lake build Tests` 当前 281 jobs，汇总门覆盖全部 imported test modules 与 target guards。
