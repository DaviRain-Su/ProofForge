...
- EVM registry 12 个程序；Counter / Pair / Flag / Maybe / Context / TipJar / Lang / Vault / Ownable / Token / Window / Phase 的 Anvil 总门 12/12。E-ADDR：`Addr20` 是一等类型，ABI 编成一个 `address`，IR / storage 仍摊三叶。
