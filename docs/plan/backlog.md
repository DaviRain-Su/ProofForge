...
- **当前可验证基线（2026-08-27）**：Lean 汇总 215 jobs；SVM manifest 全 51 programs；
...
- `lake build Tests` 当前 215 jobs，汇总门覆盖全部 imported test modules 与 target guards。
