...
| **SVM-SDK-9 general remainder（ATA + Token state slices 已集成）** | SVM-SDK-8、SVM-RT-3 | role-typed static ATA 已组合 generic invoke；canonical program ids 与 exact SPL base views 已组合 account leaves；继续分模块收口 rent-aware resize、runtime-selected/UTF-8 Memo 与 Token-2022 typed extension facade；未知 extension/runtime account geometry 继续 fail closed；见 R3-010/011 |
