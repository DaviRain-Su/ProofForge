...
| SVM storage SDK | POD field、fixed Vec/Queue、packed BitSet、enumerable UInt64 Set、ordered Map/RBMap、one-based allocator、bounded cursor、transient scratch | 账户内 `HashMap`、跨 invocation heap、运行时任意 geometry |
...
SVM BitSet、R3-027 persistent SVM enumerable Set，以及 R2-010 checked
...
runtime-selected ATA/Memo geometry、UTF-8 Memo、richer persistent key/value shapes/versioned codec 与
