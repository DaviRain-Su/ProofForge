...
runtime-selected ATA/Memo geometry、UTF-8 Memo 与更多 Token-2022 extension
semantics 仍待完成（resize rent top-up 已由 `svm-sdk-001` 收口；owner reassignment 已由 `svm-sdk-002` 标 n/a 永久 fail-closed）。R3-014 又以纯 `pf_inline` `Svm.Sdk.Sysvar` facade 收口已有 Clock、
