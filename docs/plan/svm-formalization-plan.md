...
下一刀：**SF-4** TransientModel（[sf-006](tasks/sf-006.md)）。
...
3. ~~[sf-001](tasks/sf-001.md)~~ / ~~[sf-002](tasks/sf-002.md)~~ / ~~[sf-003](tasks/sf-003.md)~~ / ~~[sf-004](tasks/sf-004.md)~~ / ~~[sf-005](tasks/sf-005.md)~~ → [sf-006](tasks/sf-006.md)（Transient）  
4. 按波次向下，每片更新矩阵  
