...
Authenticate callback entries with full predecessor/current AccountId equality before adding
parallel `promise_and`, transfer actions, or broader result codecs.
