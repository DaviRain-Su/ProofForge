...
- NEAR target lowering binds only view `.scalar .uint128` to canonical policy
  `near-json-u128-string-v1`; malformed frames and mutating methods fail closed. The policy is part
  of canonical program identity and therefore the registry digest.
