...
`svm-app-004`/`005` (CancelMultiple cap →4 + mixed bid/ask + four-id), `svm-sem-006`/`007`/`008` (E∞ walked `r7` + account-0).
...
- Agave/ELF host adequacy (E∞) — knives `svm-sem-006`/`007`/`008` walked `r7` + account-0 (full Loader/syscall/ELF still open)
