...
| **N13** | [`wsm-near-promise-general-001`](tasks/wsm-near-promise-general-001.md) | 有界 Promise handle、N 路 join（仍 fail-closed 上限） | N12 | DAG sandbox（handle SDK **step 1**；Extract + `andN` 仍开） |
