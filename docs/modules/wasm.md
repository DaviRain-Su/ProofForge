...
| NEAR Protocol | [`Wasm/Near`](near.md) | Lean → WAT → `.wasm`（bounded Borsh/arena + raw storage + direct collections；[wsm-near-iterable-001](../plan/tasks/wsm-near-iterable-001.md)） |
