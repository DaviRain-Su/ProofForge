...
case "$program_name" in
  Phoenix|PhoenixV1Profile|RawEntry|Info|LamportTransfer|FeatureBits|MemberDirectory) ;;
  *)
    echo "surfpool-smoke: supported programs: Phoenix, PhoenixV1Profile, RawEntry, Info, LamportTransfer, FeatureBits, MemberDirectory" >&2
    exit 1
    ;;
esac
