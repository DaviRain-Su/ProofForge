#!/usr/bin/env bash
# Live AlphaNet: credit another AccountID's card via three UINT64 limbs.
# Destination rLpgximdBvEHy8TxUwyj6mjCRNcJju5qGG =
# d0bc2a540b15411f44a24dfb58d23ad5d9d9b350 → w2=1353963993.
set -euo pipefail
...
# Little-endian limbs of d0bc2a540b15411f44a24dfb58d23ad5d9d9b350.
...
echo "xrpl-alphanet-send: building XrplSend.wasm" >&2
