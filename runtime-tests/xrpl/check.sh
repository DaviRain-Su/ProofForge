...
for wat in wats:
    ...
    elif wat.stem == "XrplDual":
        exports = need_exports_dual
    elif wat.stem == "XrplLatch":
        exports = need_exports_latch
    elif wat.stem == "XrplEscape":
        exports = need_exports_escape
    elif wat.stem == "XrplFrost":
    ...
    elif wat.stem == "XrplBrace":
        exports = need_exports_brace
    elif wat.stem == "XrplClamp":
        exports = need_exports_clamp
    elif wat.stem == "XrplClasp":
        exports = need_exports_clasp
    elif wat.stem == "XrplCleft":
        exports = need_exports_cleft
    elif wat.stem == "XrplClip":
    ...
    elif wat.stem == "XrplRevoke":
        exports = need_exports_revoke
    elif wat.stem == "XrplReed":
        exports = need_exports_reed
    elif wat.stem == "XrplRake":
        exports = need_exports_rake
    elif wat.stem == "XrplRaid":
        exports = need_exports_raid
    elif wat.stem == "XrplRamp":
        exports = need_exports_ramp
    elif wat.stem == "XrplRank":
