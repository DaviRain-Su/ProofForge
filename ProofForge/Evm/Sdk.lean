...
static storage declarations, persistent bounded UInt64 storage vectors/bitmaps, and bounded static
role sets. Applications import this module rather than target Runtime, Ops, IR, or Emit internals.
-/
