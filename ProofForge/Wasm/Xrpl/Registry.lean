...
def entries : Array Entry := #[
  ...
  { name := "XrplCinder", digest := "e1e45412ebb2dcdd" },
  ...
  { name := "XrplRank", digest := "dc7acc658d048610" },
  { name := "XrplRant", digest := "5f79d58819a43529" },
  { name := "XrplDraw", digest := "169b4a3422828871" }
  ]
