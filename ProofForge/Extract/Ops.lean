...
@[match_pattern] def Val.xrplFlushBal (v : Val) : Val :=
  .ext (.xrpl .flushBal) #[v]
@[match_pattern] def Val.xrplPeekOwner (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekOwner) #[w0, w1, w2]
@[match_pattern] def Val.xrplFlushHalt (v : Val) : Val :=
  .ext (.xrpl .flushHalt) #[v]
@[match_pattern] def Val.xrplPeekHalt (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekHalt) #[w0, w1, w2]
@[match_pattern] def Val.xrplFlushSupp (v : Val) : Val :=
  .ext (.xrpl .flushSupp) #[v]
@[match_pattern] def Val.xrplPeekSupp (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekSupp) #[w0, w1, w2]
@[match_pattern] def Val.xrplFlushCap (v : Val) : Val :=
  .ext (.xrpl .flushCap) #[v]
@[match_pattern] def Val.xrplPeekCap (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekCap) #[w0, w1, w2]
@[match_pattern] def Val.xrplFlushAllw (v : Val) : Val :=
...
@[match_pattern] def Val.xrplFlushEsc (v : Val) : Val :=
  .ext (.xrpl .flushEsc) #[v]
@[match_pattern] def Val.xrplPeekEsc (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekEsc) #[w0, w1, w2]
@[match_pattern] def Val.xrplFlushDue (v : Val) : Val :=
  .ext (.xrpl .flushDue) #[v]
@[match_pattern] def Val.xrplPeekDue (w0 w1 w2 : Val) : Val :=
  .ext (.xrpl .peekDue) #[w0, w1, w2]
