...
def extractedTipJar : Program :=
  { name := "TipJar"
    slots := #[{ name := "dummy" }]
    methods := #[
      { kind := .init, name := "Examples.Evm.TipJar.init", ixName := "initialize", paramCount := 1
        ops := #[.returnState (.lit 0)] },
      { kind := .increment, name := "Examples.Evm.TipJar.deposit", ixName := "deposit", paramCount := 1
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.evmDeposit (.arg 0), .returnU64 (.arg 0)]
            #[.errorOverflow]
        ] },
      { kind := .increment, name := "Examples.Evm.TipJar.logTip", ixName := "logTip", paramCount := 1
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.evmLog "Tipped" (.arg 0), .returnU64 (.arg 0)]
            #[.errorOverflow]
        ] },
      { kind := .increment, name := "Examples.Evm.TipJar.payout", ixName := "payout", paramCount := 2
        paramWidths := #[20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
      ...
      { kind := .get, name := "Examples.Evm.TipJar.callValue", ixName := "callValue", paramCount := 0
        ops := #[.returnU64 .evmCallValue] },
      { kind := .get, name := "Examples.Evm.TipJar.caller20", ixName := "caller20", paramCount := 0
        retWidths := #[20], retCount := 3
        ops := #[.returnU64 .evmCallerW0, .returnU64 .evmCallerW1, .returnU64 .evmCallerW2] },
      { kind := .get, name := "Examples.Evm.TipJar.callerW0", ixName := "callerW0", paramCount := 0
        ops := #[.returnU64 .evmCallerW0] },
      { kind := .get, name := "Examples.Evm.TipJar.callerW1", ixName := "callerW1", paramCount := 0
        ops := #[.returnU64 .evmCallerW1] },
      { kind := .get, name := "Examples.Evm.TipJar.callerW2", ixName := "callerW2", paramCount := 0
        ops := #[.returnU64 .evmCallerW2] },
      { kind := .get, name := "Examples.Evm.TipJar.chainId", ixName := "chainId", paramCount := 0
        ops := #[.returnU64 .evmChainId] },
      { kind := .get, name := "Examples.Evm.TipJar.get", ixName := "get", paramCount := 0
        ops := #[.returnU64 (.lit 0)] },
      { kind := .get, name := "Examples.Evm.TipJar.self20", ixName := "self20", paramCount := 0
        retWidths := #[20], retCount := 3
        ops := #[.returnU64 .evmSelfW0, .returnU64 .evmSelfW1, .returnU64 .evmSelfW2] },
      { kind := .get, name := "Examples.Evm.TipJar.selfBal", ixName := "selfBal", paramCount := 0
        ops := #[.returnU64 .evmSelfBalance] },
      { kind := .get, name := "Examples.Evm.TipJar.selfLow", ixName := "selfLow", paramCount := 0
        ops := #[.returnU64 .evmSelf] },
      { kind := .get, name := "Examples.Evm.TipJar.selfW0", ixName := "selfW0", paramCount := 0
        ops := #[.returnU64 .evmSelfW0] },
      { kind := .get, name := "Examples.Evm.TipJar.selfW1", ixName := "selfW1", paramCount := 0
        ops := #[.returnU64 .evmSelfW1] },
      { kind := .get, name := "Examples.Evm.TipJar.selfW2", ixName := "selfW2", paramCount := 0
        ops := #[.returnU64 .evmSelfW2] },
      { kind := .get, name := "Examples.Evm.TipJar.timestamp", ixName := "timestamp", paramCount := 0
...
def extractedVault : Program :=
  { name := "Vault"
    slots := #[{ name := "dummy" }]
    methods := #[
      { kind := .init, name := "Examples.Evm.Vault.init", ixName := "initialize", paramCount := 1
        ops := #[.returnState (.lit 0)] },
      { kind := .increment, name := "Examples.Evm.Vault.credit", ixName := "credit", paramCount := 2
        paramWidths := #[20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
      ...
      { kind := .increment, name := "Examples.Evm.Vault.pull", ixName := "pull", paramCount := 3
        paramWidths := #[20, 20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
      ...
      { kind := .increment, name := "Examples.Evm.Vault.setU64", ixName := "setU64", paramCount := 2
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.mapSetU64 (.lit 0) (.arg 0) (.arg 1), .returnU64 (.arg 1)]
            #[.errorOverflow]
        ] },
      { kind := .get, name := "Examples.Evm.Vault.get", ixName := "get", paramCount := 0
        ops := #[.returnU64 (.lit 0)] },
      { kind := .get, name := "Examples.Evm.Vault.getU64", ixName := "getU64", paramCount := 1
        ops := #[.mapGetU64 (.lit 0) (.arg 0), .returnU64 (.arg 0)] },
      { kind := .get, name := "Examples.Evm.Vault.held", ixName := "held", paramCount := 1
        paramWidths := #[20]
        ops := #[.evmTokenBalanceOfSelf (.field (.arg 0) "w0") (.field (.arg 0) "w1")
            (.field (.arg 0) "w2"), .returnU64 (.field (.arg 0) "w0")] },
      { kind := .get, name := "Examples.Evm.Vault.shareOf", ixName := "shareOf", paramCount := 1
        paramWidths := #[20]
...
def extractedOwnable : Program :=
  { name := "Ownable"
    ...
    methods := #[
      { kind := .init, name := "Examples.Evm.Ownable.init", ixName := "initialize", paramCount := 1
        paramWidths := #[20]
        ops := #[
          .returnState (.field (.arg 0) "w0"), .returnState (.field (.arg 0) "w1"),
          .returnState (.field (.arg 0) "w2"), .returnState (.lit 0)
        ] },
      { kind := .increment, name := "Examples.Evm.Ownable.approve", ixName := "approve", paramCount := 3
        paramWidths := #[20, 20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
      ...
      { kind := .increment, name := "Examples.Evm.Ownable.bump", ixName := "bump", paramCount := 1
        ops := #[
      ...
      { kind := .increment, name := "Examples.Evm.Ownable.logInc", ixName := "logInc", paramCount := 1
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.evmLog "Incremented" (.arg 0), .returnU64 (.arg 0)]
            #[.errorOverflow]
        ] },
      { kind := .increment, name := "Examples.Evm.Ownable.spend", ixName := "spend", paramCount := 3
        paramWidths := #[20, 20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.mapSetPair (.lit 0) (.field (.arg 0) "w0") (.field (.arg 0) "w1")
      ...
      { kind := .get, name := "Examples.Evm.Ownable.allowance", ixName := "allowance", paramCount := 2
        paramWidths := #[20, 20]
        ops := #[
      ...
      { kind := .get, name := "Examples.Evm.Ownable.get", ixName := "get", paramCount := 0
        ops := #[.returnU64 (.field (.arg 0) "value")] },
      { kind := .get, name := "Examples.Evm.Ownable.ownerOf", ixName := "ownerOf", paramCount := 0
        retWidths := #[20], retCount := 3
        ops := #[
...
def extractedToken : Program :=
  { name := "Token"
    slots := #[{ name := "dummy" }]
    methods := #[
      { kind := .init, name := "Examples.Evm.Token.init", ixName := "initialize", paramCount := 1
        ops := #[.returnState (.lit 0)] },
      { kind := .increment, name := "Examples.Evm.Token.approve", ixName := "approve", paramCount := 2
        paramWidths := #[20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
      ...
      { kind := .increment, name := "Examples.Evm.Token.logApprove", ixName := "logApprove", paramCount := 1
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.evmLog "Approval" (.arg 0), .returnU64 (.arg 0)]
            #[.errorOverflow]
        ] },
      { kind := .increment, name := "Examples.Evm.Token.logXfer", ixName := "logXfer", paramCount := 1
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.evmLog "Transfer" (.arg 0), .returnU64 (.arg 0)]
            #[.errorOverflow]
        ] },
      { kind := .increment, name := "Examples.Evm.Token.mint", ixName := "mint", paramCount := 2
        paramWidths := #[20, 8]
        ops := #[
          .ite .ne (.lit 0) (.lit 1)
            #[.mapSetAddr (.lit 0) (.field (.arg 0) "w0") (.field (.arg 0) "w1")
      ...
      { kind := .increment, name := "Examples.Evm.Token.transfer", ixName := "transfer", paramCount := 2
        paramWidths := #[20, 8]
        ops := #[
          .ite .ge
      ...
      { kind := .increment, name := "Examples.Evm.Token.transferFrom", ixName := "transferFrom",
        paramCount := 3
        paramWidths := #[20, 20, 8]
        ops := #[
          .ite .ge
      ...
      { kind := .get, name := "Examples.Evm.Token.allowanceOf", ixName := "allowanceOf", paramCount := 2
        paramWidths := #[20, 20]
        ops := #[
          .mapGetPair (.lit 1) (.field (.arg 0) "w0") (.field (.arg 0) "w1")
            (.field (.arg 0) "w2") (.field (.arg 1) "w0") (.field (.arg 1) "w1")
      ...
      { kind := .get, name := "Examples.Evm.Token.balanceOf", ixName := "balanceOf", paramCount := 1
        paramWidths := #[20]
        ops := #[.mapGetAddr (.lit 0) (.field (.arg 0) "w0") (.field (.arg 0) "w1")
            (.field (.arg 0) "w2"), .returnU64 (.field (.arg 0) "w0")] },
      { kind := .get, name := "Examples.Evm.Token.get", ixName := "get", paramCount := 0
        ops := #[.returnU64 (.lit 0)] }
    ] }
